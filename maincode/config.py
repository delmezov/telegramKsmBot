...
token = "1033623575:AAEnzseiW_fIrJAe7BQRRj-iyKwWHkbE5cU"



chat_name = "@agro_zerno"


proxy_const_ukr = {'https': 'socks5://Dzhabri:1068098b@45.155.206.130:1490'}
proxy_const_ger = {'https': 'socks5://Dzhabri:a3e8af21@195.123.248.48:1490'}
...
seeds_photo = {
    'Рис': "content/рис.png",
    'Ячмень': "content/ячмень.png",
    'Соя': "content/соя.png",
    'Горох': "content/горох.png",
    'Пшеница': "content/пшеница.png",
    'Кукуруза': "content/кукуруза.png",
    'Семечка': "content/семечка.png",
    'Лен': "content/лен.png"
}
...
last_message = '''<strong>Спасибо ваше объявление отправлено в группу @agro_zerno</strong>'''
...
seed_keyboard = telebot.types.ReplyKeyboardMarkup(resize_keyboard=True).row(
    'Соя', 'Горох', 'Ячмень')
seed_keyboard.add('Пшеница', 'Кукуруза')
